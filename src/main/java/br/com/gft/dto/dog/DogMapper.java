...
public class DogMapper {
	...
	public static Dog fromDTO(DogRequestDTO dto) {
		...
		return new Dog(null, dto.getName(), null, BreedMapper.fromDTO(dto.getBreed()), client);

	}

	public static DogResponseDTO fromEntity(Dog obj) {
		return new DogResponseDTO(obj.getId(), obj.getName(), obj.getReg_cod(), obj.getGuardian().getId(),
				BreedMapper.fromEntity(obj.getBreed()));
	}
